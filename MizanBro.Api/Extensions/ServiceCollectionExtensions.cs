using MizanBro.Api.Services;
using MizanBro.Application.DTOs.Settings;
using MizanBro.Application.Interfaces;
...
using MizanBro.Infrastructure.Identity.Services;
using MizanBro.Infrastructure.Shared.Services;
    ...
    public static class ServiceCollectionExtensions
    {
        ...
        private static void RegisterSwagger(this IServiceCollection services)
        {
            services.AddSwaggerGen(c =>
            {
                ...
                c.IncludeXmlComments(string.Format(@"{0}\MizanBro.Api.xml", System.AppDomain.CurrentDomain.BaseDirectory));
